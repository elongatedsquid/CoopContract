...
\section*{Samarbetskontrakt i kursen pgk för grupp \texttt{C.104a}}
...
\emph{Namn} & \emph{Underskrift} \\
\\ Malte Axner & \dotfill \\
\\ Ellinor Brorsson & \dotfill \\
\\ Gustaf Lindberg & \dotfill \\
\\ Jonathan Neilan & \dotfill \\
\end{tabular}
